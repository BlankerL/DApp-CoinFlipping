...
- **Highly annoymous.** User cannot see the counterparties' username in the game and game history. In game history, only the user's index and winner's index will be provided. 
